...
<body>
  ...
  <footer class="footer">
    <div class="footer-content">
      ...
      <p class="footer-text">Fast, reliable delivery across Mauritius</p>

      <div class="footer-social">
        <a href="https://www.linkedin.com/company/grabbitexpressltd/" target="_blank" rel="noopener" class="footer-social-btn" aria-label="Grabbit Express on LinkedIn">
